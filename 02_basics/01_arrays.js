...
console.log(myArr[1]);     //2 accessing array
...
console.log(myArr.includes(19));  //false because 19 does not existin array
console.log(myArr.indexOf(3));   //return index of 3 value
...
const myn1 = myArr.slice(1, 3)   // [1,2] ---> return value from index 1 to 2 
console.log(myn1);
